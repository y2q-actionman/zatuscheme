...
int main(){
  ...
  check_e_undef("(vector-ref '#(a) -1)");
  check_e_undef("(vector-ref '#(a) 100)");
  check_e_undef("(vector-ref '#() 0)");
  ...
  check_e("(let ((vec (vector 0 '(2 2 2 2) \"Anna\"))) (vector-set! vec 1 '(\"Sue\" \"Sue\")) vec)",
        "#(0 (\"Sue\" \"Sue\") \"Anna\")");
  //check_e_undef("(vector-set! '#(0 1 2) 1 \"doe\")");
  eval_text("(define tmpvec (vector 1))");
  check_e_undef("(vector-set! tmpvec -1 'hoge)");
  check_e_undef("(vector-set! tmpvec 100 'hoge)");
